...
## For nbit predictors
predictors_to_plot = ["RAS (4 ", "RAS (8 ", "RAS (16 ", "RAS (24 ", "RAS (32 ", "RAS (48 ", "RAS (64 "]
	...
	if (line.startswith("Total Instructions:")):
		...
		for pred_prefix in predictors_to_plot:
			if line.startswith(pred_prefix):
				predictor_string = tokens[0] + " - " + tokens[1].split('(')[1] + " #"+ tokens[2].split(')')[0]
				correct_predictions = float(tokens[3])
				incorrect_predictions = float(tokens[4])
...
plt.title("Mispredictions Per Thousand Instructions")
